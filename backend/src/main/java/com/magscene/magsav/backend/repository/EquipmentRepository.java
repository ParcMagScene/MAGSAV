...
public interface EquipmentRepository extends JpaRepository<Equipment, Long> {
     ...
     */
    @Query("SELECT COALESCE(e.category, 'Non catégorisé'), COUNT(e) FROM Equipment e GROUP BY e.category ORDER BY COUNT(e) DESC")
    ...
    /**
     * Récupérer tous les QR codes existants avec un préfixe donné (pour optimiser
     * la génération d'UID)
     */
