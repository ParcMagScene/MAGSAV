...
public interface PersonnelRepository extends JpaRepository<Personnel, Long> {
     ...
     */
    List<Personnel> findByFirstNameContainingIgnoreCaseOrLastNameContainingIgnoreCase(String firstName,
            String lastName);
    ...
    /**
     * Compte le personnel par statut
     */
    long countByStatus(Personnel.PersonnelStatus status);
}