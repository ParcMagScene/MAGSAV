...
import com.magscene.magsav.backend.repository.GroupedOrderRepository;
import com.magscene.magsav.backend.repository.OrderAllocationRepository;
import com.magscene.magsav.backend.repository.SupplierRepository;
...
public class GroupedOrderService {
    ...
    public List<GroupedOrder> findAll() {
        return groupedOrderRepository.findAllWithSupplier();
    }
    ...
    public void allocateItem(MaterialRequestItem item, Integer quantity) {
        ...
        if (item.getCatalogItem() != null &&
            ...
            // Pour les items libres, utiliser un fournisseur par défaut ou laisser l'admin
            // choisir
