...
INSERT INTO vehicles (
    ...
    current_location, assigned_driver, notes,
    created_at, updated_at
) VALUES 

-- Fourgons pour transport matériel
('Fourgon Principal', 'Mercedes', 'Sprinter 314', 'AB-123-CD', 'WDB9066331N123456', 'VAN', 'AVAILABLE', 'DIESEL',
 ...
 'Entrepôt Principal', 'Pierre Martin', 'Véhicule principal pour transports matériel scène',
...
('Fourgon Secours', 'Peugeot', 'Boxer L3H2', 'EF-456-GH', 'VF3ZDZYFZKS123789', 'VAN', 'AVAILABLE', 'DIESEL',
 ...
 'Entrepôt Principal', '', 'Véhicule de secours et transports légers',
 '2024-01-10 08:15:00', '2024-01-10 08:15:00'),

-- Camions pour gros matériel
('Camion Plateau', 'Iveco', 'Daily 70C18', 'IJ-789-KL', 'ZCFC470A005123456', 'TRUCK', 'AVAILABLE', 'DIESEL',
 ...
 'Entrepôt Principal', 'Marc Dubois', 'Camion plateau pour gros matériel et structures',
...
('Camion Benne', 'Renault', 'Master Benne', 'MN-012-OP', 'VF1MA000156789123', 'TRUCK', 'MAINTENANCE', 'DIESEL',
 ...
 'Garage Partenaire', 'Sophie Leroy', 'En révision complète - retour prévu fin semaine',
...
('Remorque Plateau 1', 'PTAC', 'RPL-500', 'QR-345-ST', 'FR1PTAC00500123456', 'TRAILER', 'AVAILABLE', 'OTHER',
 ...
 'Entrepôt Principal', '', 'Remorque plateau pour structures lourdes',
 '2024-01-10 09:00:00', '2024-01-10 09:00:00'),

('Remorque Fermée', 'Humbaur', 'HK253118', 'UV-678-WX', 'EUHB25311812345678', 'TRAILER', 'AVAILABLE', 'OTHER',
 2020, 0, 2500.00, '5.00 x 2.05 x 2.10',
 'ASS-2024-006', '2024-12-15', '2024-10-20',
 '2023-11-20', '2024-05-20', 0,
 '2020-05-12', 18500.00, 90.00,
 'Entrepôt Principal', '', 'Remorque fermée pour matériel sensible',
 '2024-01-10 09:15:00', '2024-01-10 09:15:00'),

-- Véhicules légers
('Voiture Service', 'Citroën', 'Berlingo', 'YZ-901-AB', 'VF7KURHZGKJ123456', 'CAR', 'AVAILABLE', 'DIESEL',
 ...
 'Bureau', 'Julie Moreau', 'Véhicule pour déplacements commerciaux et petites livraisons',
...
('Utilitaire Compact', 'Volkswagen', 'Caddy', 'CD-234-EF', 'WVWZZZ2KZD123456', 'CAR', 'RENTED_OUT', 'GASOLINE',
 ...
 'Location Externe', '', 'Loué jusqu''au 15 février - retour prévu',
 '2024-01-10 09:45:00', '2024-01-10 09:45:00'),

-- Véhicule électrique
('Fourgon Électrique', 'Nissan', 'e-NV200', 'GH-567-IJ', 'SJNFBAAE0U0123456', 'VAN', 'AVAILABLE', 'ELECTRIC',
 ...
 'Entrepôt Principal', '', 'Véhicule écologique pour livraisons urbaines',
...
('Moto Urgence', 'BMW', 'R1250GS', 'KL-890-MN', 'WB10AA110L123456', 'MOTORCYCLE', 'AVAILABLE', 'GASOLINE',
 ...
 'Bureau', 'Alex Rousseau', 'Moto pour interventions rapides et repérages',
 '2024-01-10 10:15:00', '2024-01-10 10:15:00');

-- Mise à jour des séquences pour les prochaines insertions
-- (Optionnel selon la configuration H2)