...
-- ============================================================================
-- NOTE: Les données SAV sont maintenant dans data-sav.sql pour éviter les doublons
-- et permettre une gestion séparée des statuts (PENDING, VALIDATED uniquement)
