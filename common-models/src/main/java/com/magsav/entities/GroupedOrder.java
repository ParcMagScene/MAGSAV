...
/**
 * Entité représentant une commande groupée avant transformation en SupplierProcurementOrder
 */
@Entity
...
public class GroupedOrder {
    ...
    public GroupedOrderStatus getStatus() { return status; }
    public void setStatus(GroupedOrderStatus status) { this.status = status; }
    
    public BigDecimal getCurrentAmount() { return currentAmount; }
    public void setCurrentAmount(BigDecimal currentAmount) { this.currentAmount = currentAmount; }
    
    public boolean isThresholdAlertSent() { return thresholdAlertSent; }
    public void setThresholdAlertSent(boolean thresholdAlertSent) { 
        this.thresholdAlertSent = thresholdAlertSent; 
    }
    
    public boolean isAutoValidateOnThreshold() { return autoValidateOnThreshold; }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GroupedOrder)) return false;
