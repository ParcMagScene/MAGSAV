...
import com.magsav.enums.RequestPriority;
...
public class MaterialRequest {
    ...
    public MaterialProject getProject() { return project; }
    public void setProject(MaterialProject project) { this.project = project; }
    ...
    public Set<MaterialRequestItem> getItems() { return items; }
    public void setItems(Set<MaterialRequestItem> items) { this.items = items; }
    
    public Set<OrderAllocation> getOrderAllocations() { return orderAllocations; }
    ...
    public boolean hasUnallocatedItems() {
        return items.stream().anyMatch(item -> 
            item.getRequestedQuantity() > item.getQuantityAllocated());
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MaterialRequest)) return false;
