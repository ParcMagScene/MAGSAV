 ...
 * Standard basé sur ClientManagerView avec cohérence visuelle dans toute l'application
 */
public class ToolbarUtils {
     ...
     */
    public static VBox createSearchSection(String labelText, String promptText, double width, Consumer<String> onTextChanged) {
     ...
     */
    public static VBox createFilterSection(String labelText, String[] items, String defaultValue, double width, Consumer<String> onSelectionChanged) {
