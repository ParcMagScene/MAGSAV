...
public class ViewUtils {
    ...
    public static Label createSearchLabel(String text) {
        ...
        label.setFont(Font.font(ThemeConstants.FONT_FAMILY, ThemeConstants.FONT_WEIGHT_TITLE, ThemeConstants.FONT_SIZE_NORMAL));
     ...
     */
    public static VBox createFilterBox(String labelText, String[] items, String defaultValue, Consumer<String> onSelectionChanged) {
        ...
        filterLabel.setFont(Font.font(ThemeConstants.FONT_FAMILY, ThemeConstants.FONT_WEIGHT_TITLE, ThemeConstants.FONT_SIZE_NORMAL));
     ...
     */
    public static Button createEditButton(String text, Runnable onAction, javafx.beans.binding.BooleanBinding disableBinding) {
     ...
     */
    public static Button createDeleteButton(String text, Runnable onAction, javafx.beans.binding.BooleanBinding disableBinding) {
     ...
     */
    public static Button createDetailsButton(String text, Runnable onAction, javafx.beans.binding.BooleanBinding disableBinding) {
    ...
    public static HBox createStandardToolbar(Region... components) {
        ...
        toolbar.setStyle("-fx-background-color: " + com.magscene.magsav.desktop.theme.ThemeManager.getInstance().getSelectionColor() + 
                        "; -fx-background-radius: 8; -fx-effect: dropshadow(gaussian, rgba(0,0,0,0.1), 4, 0, 0, 2);");
    ...
    public static VBox createActionsBox(String labelText, Button... buttons) {
        ...
        actionsLabel.setFont(Font.font(ThemeConstants.FONT_FAMILY, ThemeConstants.FONT_WEIGHT_TITLE, ThemeConstants.FONT_SIZE_NORMAL));
     ...
     * @param initialText Texte initial (par défaut: "📊 Chargement des statistiques...")
     * @return Label stylé pour afficher les stats
     */
    public static Label createStatsLabel(String initialText) {
        String statsText = (initialText != null && !initialText.trim().isEmpty()) ? 
                          initialText : "📊 Chargement des statistiques...";
        
        Label statsLabel = new Label(statsText);
        statsLabel.setFont(Font.font(ThemeConstants.FONT_FAMILY, ThemeConstants.FONT_WEIGHT_TITLE, ThemeConstants.FONT_SIZE_NORMAL));
     ...
     * @param applyAction Action du bouton Appliquer (optionnel, null pour l'omettre)
