...
public abstract class AbstractManagerView extends BorderPane {
    ...
    public static final double TOOLBAR_SPACING = 10.0;
    public static final double TOOLBAR_PADDING = 10.0;
    public static final String TOOLBAR_STYLE = 
    ...
    private void initializeStandardLayout() {
        ...
        // Conteneurs pour filtres et actions
        filtersContainer = new VBox(5);
        actionsContainer = new VBox(5);
    }
    ...
    /**
     * Retourne le contenu central de la vue (TableView + DetailPanel, CustomTabPane...)
    ...
    protected void finalizeSetup() {
        // Application du thème directement sur la vue (la scène sera stylée au niveau supérieur)
