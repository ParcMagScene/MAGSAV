...
public class TechnicianPlanningView extends VBox {
    ...
    private HBox createUnifiedToolbar() {
        ...
        VBox techBox = ViewUtils.createFilterBox("👤 Technicien",
                new String[] { "Tous les techniciens", "Marc Dupont", "Sophie Martin", "Thomas Leroux", "Julie Moreau",
                        "David Rousseau" },
    ...
    private VBox createPlanningControlSection() {
        ...
        controlTitle.setStyle(
                "-fx-font-size: 14px; -fx-font-weight: bold; -fx-text-fill: " + StandardColors.PRIMARY_BLUE + ";");
        ...
        planningDate.setStyle("-fx-background-radius: 4px; -fx-border-color: " + StandardColors.PRIMARY_BLUE
        ...
        technicianFilter.getItems().addAll("Tous les techniciens", "Marc Dupont", "Sophie Martin", "Thomas Leroux",
                "Julie Moreau", "David Rousseau");
        technicianFilter.setValue("Tous les techniciens");
        technicianFilter.setStyle("-fx-background-radius: 4px; -fx-border-color: " + StandardColors.PRIMARY_BLUE
                + "; -fx-border-radius: 4px;");
    ...
    private VBox createPlanningTableSection() {
        ...
        tableTitle.setStyle(
                "-fx-font-size: 14px; -fx-font-weight: bold; -fx-text-fill: " + StandardColors.getTextColor() + ";");
    ...
    private VBox createOptimizationSummarySection() {
        ...
        analysisLabel.setStyle(
                "-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + StandardColors.getTextColor() + ";");
        ...
        summarySection.getChildren().addAll(summaryTitle, kpiGrid, analysisLabel, optimizationSummaryArea,
                recommendationsBox);
    ...
    private GridPane createKPIGrid() {
        ...
        for (int i = 0; i < kpiLabels.length; i++) {
            ...
            kpiValues[i].setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: "
                    + StandardColors.getTextColor() + ";");
    ...
    private VBox createRecommendationsBox() {
        ...
        recommendationsTitle.setStyle(
                "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + StandardColors.SUCCESS_GREEN + ";");
        ...
        recommendationsBox.getChildren().addAll(recommendationsTitle, recommendation1, recommendation2,
                recommendation3);
    ...
    private TableView<TechnicianSchedule> createPlanningTable() {
        ...
        locationCol.setCellValueFactory(data -> {
            ...
            return new javafx.beans.property.SimpleStringProperty(
                    "📍 " + location + " (" + String.format("%.1f km", distance) + ")");
        });
        ...
        table.setRowFactory(tv -> {
            ...
            Runnable updateStyle = () -> {
                if (row.isEmpty() || row.getItem() == null) {
                    ...
                    row.setStyle(backgroundColor + "; -fx-border-color: " + StandardColors.NEUTRAL_LIGHT
    ...
    private void displayScheduleDetails(TechnicianSchedule schedule) {
        // Afficher les détails de l'intervention sélectionnée; // Cette méthode
        // pourrait ouvrir un dialogue détaillé ou mettre à jour une zone d'information
    }
    ...
    private void updatePlanningMetrics() {
        // Mise à jour des métriques affichées dans l'interface; // Cette méthode met à
        // jour les KPIs et indicateurs
    }
