...
public class SettingsView extends VBox {
    ...
    private void initializeView() {
        ...
        // Titre principal
        Label titleLabel = new Label("⚙️ Paramètres de l'application");
        titleLabel.setFont(Font.font("System", FontWeight.BOLD, 24));
        titleLabel.getStyleClass().add("settings-title");
        
        // TabPane avec les différents onglets
        TabPane tabPane = createSettingsTabPane();
        
        getChildren().addAll(titleLabel, tabPane);
    }
    
    /**
     * Création du TabPane avec tous les onglets de paramètres
     */
    private TabPane createSettingsTabPane() {
        ...
        // Onglet Application
        Tab applicationTab = new Tab("🚀 Application");
        applicationTab.setContent(createApplicationTab());
        applicationTab.setClosable(false);
        
        // Onglet Base de données
        Tab databaseTab = new Tab("💾 Base de données");
        databaseTab.setContent(createDatabaseTab());
    ...
    private ScrollPane createNotificationsTab() {
        ...
        specificSection.getChildren().addAll(specificTitle, savNotifBox, equipmentNotifBox, contractNotifBox, vehicleNotifBox);
    ...
    private ScrollPane createCategoriesTab() {
        ...
        Label equipmentCount = new Label("Équipements: " + categoryManager.getEquipmentCategories().size() + " catégories");
    ...
    private void showAddCategoryDialog(CategoryType type) {
        ...
        dialog.showAndWait().ifPresent(category -> {
            ...
            showSuccessAlert("Catégorie ajoutée", "La catégorie '" + category.getName() + "' a été ajoutée avec succès.");
        });
    }
    ...
    private void showDeleteCategoryConfirmation(Category category, CategoryType type) {
        ...
        confirm.setContentText("⚠️ Cette action est irréversible. Tous les éléments associés à cette catégorie devront être recatégorisés.");
