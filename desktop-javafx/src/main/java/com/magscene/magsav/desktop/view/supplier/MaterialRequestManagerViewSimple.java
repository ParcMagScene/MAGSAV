...
public class MaterialRequestManagerViewSimple extends BaseManagerView<Object> {
    ...
    protected Pane createMainContent() {
        ...
        // Titre
        Label titleLabel = new Label("📝 Gestion des Demandes de Matériel");
        titleLabel.setFont(Font.font("System", FontWeight.BOLD, 16));
        
        // Table des demandes
        createRequestTable();
        
        mainContainer.getChildren().addAll(statsBar, titleLabel, requestTable);
    ...
    protected void initializeContent() {
        // Les données seront chargées après l'initialisation par loadRequestsFromBackend() ou createTestData()
    ...
    private void createTestData() {
        requestList.addAll(
            new RequestData("DR-001", "Éclairage concert jazz", "Thomas Bernard", "🔴 Haute", "⏳ En attente", "15/01/2024"),
            new RequestData("DR-002", "Réparation micros HF", "Sophie Lambert", "🚨 Urgent", "✅ Approuvée", "14/01/2024"),
            new RequestData("DR-003", "Câblage sonorisation", "Marc Rousseau", "🟡 Moyenne", "📦 Allouée", "12/01/2024")
        );
    }
    ...
    private String formatStatus(RequestStatus status) {
        ...
        switch (status) {
            ...
            case INTEGRATED: return "📦 Intégrée";
            case PARTIALLY_DELIVERED: return "📫 Partiellement livrée";
            case COMPLETED: return "✔️ Terminée";
    ...
    private String formatDate(Object dateTime) {
        if (dateTime == null) return LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
    ...
    public static class RequestData {
        ...
        public void setBackendId(Long id) { this.backendId = id; }
    }
    ...
    private com.magsav.enums.RequestContext parseContext(String category) {
        if (category == null) return com.magsav.enums.RequestContext.EVENT;
        switch (category.toUpperCase()) {
            case "SPECTACLE":
            case "PRODUCTION": 
            case "EVENT": return com.magsav.enums.RequestContext.EVENT;
            case "MAINTENANCE": return com.magsav.enums.RequestContext.MAINTENANCE;
            case "RENOUVELLEMENT":
            case "STOCK": return com.magsav.enums.RequestContext.STOCK;
            case "DÉVELOPPEMENT":
            case "RESEARCH": return com.magsav.enums.RequestContext.RESEARCH;
            case "SALES": return com.magsav.enums.RequestContext.SALES;
            case "INSTALLATION": return com.magsav.enums.RequestContext.INSTALLATION;
            case "SAV": return com.magsav.enums.RequestContext.SAV;
            case "TRAINING": return com.magsav.enums.RequestContext.TRAINING;
            default: return com.magsav.enums.RequestContext.OTHER;
        }
    }
    
    private com.magsav.enums.RequestUrgency parseUrgency(String priority) {
        if (priority == null) return com.magsav.enums.RequestUrgency.NORMAL;
