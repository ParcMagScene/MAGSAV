...
public class MaterialRequestDialog extends Dialog<MaterialRequestDialog.RequestResult> {
    ...
    private Callback<TableColumn<MaterialItem, String>, TableCell<MaterialItem, String>> createComboBoxCellFactory(List<String> options) {
    ...
    public static class MaterialItem {
        ...
        public StringProperty suggestedSupplierProperty() { return suggestedSupplier; }
        ...
        public String getSuggestedSupplier() { return suggestedSupplier.get(); }
        public void setSuggestedSupplier(String suggestedSupplier) { this.suggestedSupplier.set(suggestedSupplier); }
    }
}