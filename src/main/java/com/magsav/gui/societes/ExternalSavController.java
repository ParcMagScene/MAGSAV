...
public class ExternalSavController {
  private static final String TYPE = "SAV_EXTERNE";
  ...
  @FXML private void onDelete() {
    ...
    var confirm = new Alert(Alert.AlertType.CONFIRMATION,
        "Supprimer le SAV externe \"" + sel.nom() + "\" ?").showAndWait();
  ...
  private void openForm(Societe current) {
    try {
      ...
      d.setTitle(current == null ? "Ajouter un SAV externe" : "Modifier le SAV externe");
