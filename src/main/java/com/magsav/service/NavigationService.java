...
public final class NavigationService {
    ...
    public static void openProductManagement() {
        ...
        Views.openInNewWindow("/fxml/management/product_management.fxml", "Gestion des Produits");
    }
    
    public static void openCategories() {
        AppLogger.info("gui", "Navigation: Ouverture fenêtre Catégories");
        try {
            Views.openInNewWindow("/fxml/categories.fxml", "Catégories");
    ...
    public static void openRequestsEquipment() {
        ...
        Views.openInNewWindow("/fxml/requests_equipment.fxml", "Demandes d'équipement");
    }
    ...
    public static void openNewIntervention(Long productId) {
        ...
        Views.openInNewWindow("/fxml/new_intervention.fxml", "Nouvelle intervention");
    }
